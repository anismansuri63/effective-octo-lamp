...
class MostPopularCollectionView: UICollectionView {
    ...
    private var aryBooks:[PRBook] = []
    private var didSelectBookSelectionHandler:((_ aryBook:[PRBook],_ index:Int)->Void)?
    ...
    public func loadBooks(withBooks photo:[PRBook],isTypeHide ishide:Bool = false ){
        self.aryBooks = photo
        self.isHideType = ishide
        self.reloadData()
    }

    public func setDidSelectPhotoHandler(handler:((_ aryBook:[PRBook],_ index:Int)->Void)?){
        if handler != nil {
