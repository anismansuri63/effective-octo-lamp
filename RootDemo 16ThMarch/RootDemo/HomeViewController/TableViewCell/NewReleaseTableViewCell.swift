...
class NewReleaseTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var lblBookTitle:PRLabel!
    @IBOutlet weak var lblBookType:PRLabel!
    @IBOutlet weak var lblBookSubTitle:PRLabel!
    @IBOutlet weak var lblBookDescription:PRLabel!
